...
var how_to_use = 'This extension is for Ace Editor auto completion, based on input history.<h4>How to use?</h4><ul><li>The first time you use it, there is nothing for auto completion. Don\'t worry, just type it.</li><li>Use <b>Tab, Up, Down</b> to change selection</li><li>Use <b>Enter</b> or <b>Click</b> to input selection</li><li>Use <b>Esc</b> to cancel selection</li><li>Click <b>X</b> to delete auto completion item</li><li>Click <b>extension icon</b>(top right corner) to find more functions<ul><li>Change suggestion num</li><li>Configure your auto completion dictionary</li></ul></li></ul>';
var improvements = '<h5>ChangeLog</h5><ul><li>V1.6: User can add special keyword manually in Options page</li><li>V1.5: add more shortcut keys</li><li>V1.4: add help document</li></ul>';
